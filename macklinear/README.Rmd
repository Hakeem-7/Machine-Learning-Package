...
devtools::install_github("AU-R-Programming/Final_Project_Group_5/macklinear")
```
...
<br><br><br>
The final parameter in the function, `method` is determining the method with which confidence intervals for β will be generated. You can choose to use a "bootstrap" or "asymptotic" method for generating confidence intervals. 
<br><br><br>
